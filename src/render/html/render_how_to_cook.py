...
_render_lib_path = Constants.modules_conf.get_lib_path("How-To-Cook-Render")
_css_path = os.path.join(_render_lib_path, "index.css")
...
def _format_gradient_color(gradient: GradientColor) -> str:
    ...
    if len(gradient.color_list) == 3:
        return (f"from({gradient.color_list[0]}), color-stop(50%, {gradient.color_list[1]}), "
                f"to({gradient.color_list[2]})")
...
def render_how_to_cook(how_to_cook_version: str, dish_path: str, output_path: str):
    ...
    extra_body = f"""
        ...
        <div class="copyright-container">
            ...
            <p class="generation-info">Generated at {current_time}.<br>
